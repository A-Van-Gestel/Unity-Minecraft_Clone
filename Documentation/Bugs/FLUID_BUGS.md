...
**Not part of this bug:** the fluid *shader* rendering flat blue at that magnitude — that was tracked separately
as #20 and is **fixed** (see [`_FIXED_BUGS.md`](./_FIXED_BUGS.md) § Fluid). This entry is the CPU-side simulation
half, which that fix did not touch.
