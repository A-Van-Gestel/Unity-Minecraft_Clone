...
flowchart TD
    ...
    subgraph "DrainGenerationRequests (Main Thread, each frame)"
        A3b --> A4g{"Panic gate open?<br/>(GenerationPanicGate over lighting<br/>ReadyCount; thresholds scale with the<br/>resident square — 256/128 at vd 5,<br/>708/354 at vd 20, P-4 §3.5 + P-8)"}
        A4g -- No --> AWAIT
