...
**Existing coverage (for contrast, counts verified 2026-07-25 against a `Validate All` run — 346 baselines / 16 suites):** Lighting (88), Meshing (36, tip B36 — now including the **MP-\* orchestration** baselines B24–B27 and B31–B33, the meshing-side groundwork this roadmap's NS-3 convergence family names, plus B34–B36 guarding the chunk load-animation toggle), Behavior/fluid tick (12 + determinism gates), Placement (17), MeshBuildQueue (9), LightWorkScheduler (9), Chunk Math (46), Chunk Unload Decision (9), Pool Prune Decision (5), Pipeline Backpressure (7), Save Durability (13), Deserialization Robustness (7), Spawn
