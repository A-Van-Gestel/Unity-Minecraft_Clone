...
| P-4 | ⏳ Backpressure (§3): **§3.1 in-flight cap + §3.2 out-of-range discard SHIPPED 2026-07-21**; §3.3 unload-via-persistence (🔴), §3.4 time budgets, §3.5 panic gate remain open                                                                             |   🟡   | 🟡→🔴 |   🟢    |  ✅   |     ✅     |
