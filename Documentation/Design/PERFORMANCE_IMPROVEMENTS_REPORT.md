...
| P-4 | ✅ Backpressure (§3) **COMPLETE**: §3.1 cap + §3.2 discard + §3.3 unload-via-persistence SHIPPED 2026-07-21; **§3.4 time budgets (rate quota + ms ceiling) + §3.5 panic gate (+ §5.3 draw-drain rider) SHIPPED 2026-07-23** — fill-load FPS 13.3→29.1, hitch frames 67%→11% (editor screening GO, [benchmark](../Performance/CHUNK_PIPELINE_P4_BACKPRESSURE_2026-07-23_BENCHMARK.md)); rollback flags kept pending IL2CPP confirm |   ✅   | 🟡→🔴 |   🟢    |  ✅  |    ✅     |
