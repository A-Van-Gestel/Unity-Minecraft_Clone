...
| P-4 | ⏳ Backpressure (§3): **§3.1 in-flight cap + §3.2 out-of-range discard + §3.3 unload-via-persistence (rec 3, on CP-5's `ChunkUnloadDecision` seam) SHIPPED 2026-07-21**; §3.4 time budgets, §3.5 panic gate remain open                                 |   🟡   | 🟡→🔴 |   🟢    |  ✅  |    ✅     |
