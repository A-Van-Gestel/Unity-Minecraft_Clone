...
**Universal regression gate for every phase**: `Minecraft Clone/Dev/Validate Meshing` (tip **B21** — new baselines take **B22+**) green, `Minecraft Clone/Dev/Validate Mesh Build Queue`
