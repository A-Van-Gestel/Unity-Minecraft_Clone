...
namespace Editor.Validation.Lighting
{
    ...
    /// <c>PullBackClaimStillSupported</c> mirrors the write condition, the sky BFS seeding re-spreads
    ...
    /// <list type="bullet">
    /// <item><b>B62</b> — skylight: a seam cliff face's cross-seam stamp survives its own column's
    ...
    public static partial class LightingValidationSuite
    {
        ...
        /// <summary>
        /// Registers the Bug-15 stamp baselines (B62 sky, B63 RGB; called from
        ...
        static partial void AddBug15StampBaselineScenarios(List<Scenario> scenarios)
        {
            scenarios.Add(new Scenario(
                "B62: A seam cliff face's cross-seam skylight surface stamp survives a same-column border edit (Bug 15 guard, promoted from K15b)",
        ...
        /// only transparent neighbor is the east chunk's border air — its skylight surface stamp
        /// (15 − 1 = 14, the B39 rule) is fed exclusively cross-seam. Placing one block atop the
        /// cliff's border column triggers that column's skylight recalc, which wipes the stamp; the
