...
> **B1–B16**. The forward **execution-wave plan** (§6 — harness Waves 1–3 DONE; MH-2/MH-7 build-alongside; MH-8
> gated) and the per-gap detail (`MH-2/7/8`) are in
