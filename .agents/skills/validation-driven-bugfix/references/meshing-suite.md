...
> **Since then the suite grew past the job harness — tip is now B39 (39 baselines, 2026-07-26):** B18–B21
...
> lighting schedule too and which neither harness executes). When adding a scenario, put it in the partial that matches its *unit*,
